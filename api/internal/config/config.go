...
type AppConfig struct {
	...
	Version string `yaml:"version" env:"VERSION" env-default:"1.1.0"`
...
type DatabaseConfig struct {
	Type     string `yaml:"type" env:"TYPE" env-default:"postgres"` 
