...
// ErrorCodesMap содержит карту кодов ошибок
...
// GetErrorInfo возвращает информацию об ошибке по коду
func GetErrorInfo(code ErrorCode) ErrorInfo {
	if info, exists := ErrorCodesMap[code]; exists {
		return info
	}

	// Возвращаем стандартную ошибку, если код не найден
	return ErrorInfo{
...
// error возвращает ошибку на основе ErrorInfo
